...
s0_mecw_plot <- ggplot(data=s0_mecw, aes(x=year, y=value, group=energy_technologies)) +
  geom_line(aes(color=energy_technologies))+
  geom_point(aes(color=energy_technologies))+
  guides(color = guide_legend(title = "Energy technologies (renewables only)")) +
  theme_classic()+
...
s1_mecw_plot <- ggplot(data=s1_mecw, aes(x=year, y=value, group=energy_technologies)) +
  geom_line(aes(color=energy_technologies))+
  geom_point(aes(color=energy_technologies))+
  guides(color = guide_legend(title = "Energy technologies (renewables only)")) +
  theme_classic()+
...
s2_mecw_plot <- ggplot(data=s2_mecw, aes(x=year, y=value, group=energy_technologies)) +
  geom_line(aes(color=energy_technologies))+
  geom_point(aes(color=energy_technologies))+
  guides(color = guide_legend(title = "Energy technologies (renewables only)")) +
  theme_classic()+

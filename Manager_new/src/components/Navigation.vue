                ...
                <table>
                  <tr>
                    <td v-bind:class="{ active: isActive('/') }"><router-link to="/" class='nav-item'><a class="nav-link" :class="{ 'text-light': isDark }" v-b-tooltip.hover title="Home">HOME</a></router-link></td>
                      <!-- <td v-bind:class="{ active: isActive('/scenarios') }"><router-link to="/scenarios" class='nav-item'><a class="nav-link" :class="{ 'text-light': isDark }" v-b-tooltip.hover title="Create model scenarios">ASSUMPTIONS</a></router-link></td> -->
                    ...
                    <td v-bind:class="{ active: isActive('/report') }"><router-link to="/report" class='nav-item'><a class="nav-link" :class="{ 'text-light': isDark }" v-b-tooltip.hover title="View report tables & charts">REPORT</a></router-link></td>

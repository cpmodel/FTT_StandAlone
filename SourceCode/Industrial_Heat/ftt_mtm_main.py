    ...
    if year > histend['IUD3']:
        ...
        for t in range(1, no_it+1):
            ...
            ############################ FTT ##################################
                ...
                reg_vs_exog = ((dUkTK + endo_ued) > data['IRG3'][r, :, 0]) & (data['IRG3'][r, :, 0] >= 0.0)
                ...
                dUkREG = -(endo_ued - endo_shares*IUD3lt[r,np.newaxis])*isReg[r, :].reshape([len(titles['ITTI'])])

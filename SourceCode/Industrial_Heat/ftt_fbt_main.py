    ...
    if year > histend['IUD2']:
        ...
        for t in range(1, no_it+1):
            ...
            ############################ FTT ##################################
                ...
                reg_vs_exog = ((dUkTK + endo_ued)/data['BIC2'][:, :, ctti["13 Capacity factor mean"]]/8766 > data['IRG2'][r, :, 0]) & (data['IRG2'][r, :, 0] >= 0.0)
                ...
                data['IWS2'][r, :, 0] = (endo_ued + dUk)/(np.sum(endo_ued)+dUtot)

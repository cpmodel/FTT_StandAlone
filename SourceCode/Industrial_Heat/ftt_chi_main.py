    ...
    if year > histend['IUD1']:
        ...
        for t in range(1, no_it+1):
            ...
            ############################ FTT ##################################
                ...
                reg_vs_exog = ((dUkTK + endo_ued)/data['BIC1'][:, :, ctti["13 Capacity factor mean"]]/8766 > data['IRG1'][r, :, 0]) & (data['IRG1'][r, :, 0] >= 0.0)
                ...
                data['IWS1'][r, :, 0] = (endo_ued + dUk)/(np.sum(endo_ued)+dUtot)

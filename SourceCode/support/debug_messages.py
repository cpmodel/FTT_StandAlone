...
def data_loading_message(scen, var, dims, read, timeline="None", reg_index="None"):
    print(f"Critical error running data_loading, reading in csv files for {var}:")
...
input_functions_message = data_loading_message

...
This is a transcription of the FTT Cost Curves routine from Fortran to python.


NB: NR is rti, NT2 is t2ti, NJ is jti, NER is erti, NM is mti, NC2 is c2ti
'''
...
def cost_curves(BCET,BCTL,BCSC,MEWD,MEWG,MEWL,MEPD,MERC,MRCL,RERY,MPTR,PMF,MRED,MRES,mti,rti,t2ti,c2ti,jti,erti,year,dt,MERCX):
    ...
    # RERY is set in FTTinvP (here marginal_function) for fossil fuels

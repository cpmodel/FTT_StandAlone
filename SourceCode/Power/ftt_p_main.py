...
#                data['MEWK'][r, :, 0] = divide(data['MEWG'][r, :, 0], data['MEWL'][r, :, 0])/8766
            ...
            # Call the calculate_cumulative_capacity function
            cumulative_quarterly_capacity_power = calculate_cumulative_capacity_power(data, data_dt, get_sector_coupling_dict, titles)

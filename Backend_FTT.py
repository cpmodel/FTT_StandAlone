...
def scenarios_ran():
    ...
    scenario = Path('.') / 'Output' / 'Scenarios.json'
...
def retrieve_variables():
    ...
    # Load preprocessed metadata file (generated by separate python script /manager_new/update_manager_metadata.py)
    with open(Path('.') / 'measures_meta.json') as f:
...
def retrieve_chart_data(type_):
    ...
    for v,var in enumerate(variables):
        ...
        scen_meta = Path('.') / 'Output' / 'Scenarios.json'

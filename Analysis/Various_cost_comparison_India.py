...
for file_path in file_paths:
    ...
    df_filtered = df.iloc[:, [2, 3, 16, 26]]  # Selecting category and years 2025, 2035
    df_filtered.columns = ["Vehicle category", "Powertrain", "2025", "2035"]
    ...
    def plot_vehicle_cost(data, category, ax):
        ...
        # Plot the graph
        sns.barplot(data=df_final, y="Category Group", x="Cost", palette={"BEV": "green", "Diesel": "grey"}, hue="Powertrain", ax=ax, dodge=False)
    ...
    fig, ax = plt.subplots(1, 1, figsize=(4.5, 2.6), sharey=True)
    
    # Plot for MDT and HDT
    plot_vehicle_cost(df, "MDT", ax)
    #plot_vehicle_cost(df, "HDT", axes[1])

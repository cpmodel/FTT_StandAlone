...
2. Fuel cost: collected from GlobalPetrolPrices (https://www.globalpetrolprices.com/); World Bank/IMF prices. 
...
3. Edit the end-years in Utilities/Titles/VariableListing.csv. 

### Technical parameters
1. Mechanical survival rates: Taken from literature for ICEVs and assumed that EVs follow the same survival rates. Updates on the mechanical survival rates for EVs and fuel cell cars are recommended when the data become available

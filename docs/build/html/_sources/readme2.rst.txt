...
S0 is FTT Stand Alone's baseline scenario, which encorporates all current policies and projections 
...
FTT_Stand_Alone_Launcher.cmd from the command line. The front end will allow you to visulise the results of
the simulation. 
...
of variables will appear under it, from which you can select the variable to view in results visuliser. In the example 
...
The **CLASSIFICATIONS** tab can be used to check variable names, decriptions, units, dimensions, and timelines:
